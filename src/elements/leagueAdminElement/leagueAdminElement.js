  ...
  _getLeagueStructureTabContent(settings) {
    return `
      ...
      <fieldset>
        ...
        <div class="form-group-grid">
          <div class="form-group">
            <label for="promotionPositions">Promoted Teams</label>
          ...
          <div class="form-group">
            <label for="relegationPositions">Relegated Teams</label>
