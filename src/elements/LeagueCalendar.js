...
// Import shared styles if needed - for now, we will define specific ones
// import { panelStyles, buttonStyles } from './shared-styles.js';
...
class LeagueCalendar extends HTMLElement {
  ...
  // Mobile-specific styles (can be simpler if BASE_STYLES are comprehensive)
  static get MOBILE_STYLES() {
    return `
      ${LeagueCalendar.BASE_STYLES}
      .panel-header {
  ...
  render() {
    ...
    this.shadow.innerHTML = `
      <style>${isMobile ? LeagueCalendar.MOBILE_STYLES : LeagueCalendar.DESKTOP_STYLES}</style>
      ${LeagueCalendar.TEMPLATE}
    `;
